<template>
  <div>
    ...
    <div class="tabs">
      ...
      <div>
        <img src="../assets/home/s6.png" alt=""><br>
        时政
      </div>
      <div>
    ...
    <div class="recommend_news">
      <div>
        ...
        <h1><span style="float:left;color:red;">2021-4-25</span><span style="float:right">来源:新华社</span></h1>
      </div>
      <div>
        <div class="recommend_news_pic">
        ...
        <h1><span style="float:left;color:red;">2021-4-26</span><span style="float:right">来源:今日中国</span></h1>
      </div>
      <div>
        <div class="recommend_news_pic">
        ...
        <h1><span style="float:left;color:red;">2021-4-16</span><span style="float:right">来源:今日中国</span></h1>
      </div>
      <div>
        <div class="recommend_news_pic">
        ...
        <h1><span style="float:left;color:red;">2021-4-24</span><span style="float:right">来源:央视客户端</span></h1>
      </div>
    </div>
    <!-- 推荐新闻结束 -->
    <!-- 底部选项卡开始 -->
